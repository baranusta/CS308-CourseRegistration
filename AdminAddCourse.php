...
if(isset($_POST["cName"]) && isset($_POST["cCode"]) && isset($_POST["cCRN"]) && isset($_POST["cCredits"]) 
	&& isset($_POST["cSection"]) && isset($_POST["cInstructorName"])
	 && isset($_POST["cInstructorLastname"])&& isset($_POST["cCapacity"]) && isset($_POST["cSchedule"]))
{
